...
AUDIT     = os.path.join(BASE_DIR, "System_Logs", "security_audit.log")
...
def get_web_stats() -> dict:
    ...
    try:
        ...
        ftp.login('u336848474.chask.fun', 'N0r4Z0e?*12')
...
<div class="card" style="display:flex; justify-content:space-around; text-align:center;">
    ...
    <div><span style="color:#888;font-size:12px;">Visitas [Nombre_IA]:</span> <b style="color:#fff">{web['visits_charm']}</b></div>
</div>
...
def generate_text_report() -> str:
    ...
    lines.append(f"- Visitas ([Nombre_IA]: {web['visits_charm']} | Blog: {web['visits_blog']})")
