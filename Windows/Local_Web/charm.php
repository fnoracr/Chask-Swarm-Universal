    ...
    <div class="container-docs">
        ...
        <div class="intro-doc">
          ...
          <div style="text-align: center; margin-top: 10px; margin-bottom: 40px; background: rgba(255,255,255,0.02); border-radius: 12px; padding: 20px; border: 1px solid rgba(255,255,255,0.05);">
            ...
            <a href="https://github.com/fnoracr/Chask-Swarm-Universal" target="_blank" style="display: inline-block; background: #24292e; color: #fff; padding: 12px 24px; font-size: 15px; font-weight: 600; text-decoration: none; border-radius: 8px; margin: 5px; transition: background 0.2s; border: 1px solid #444;" onmouseover="this.style.background='#333'" onmouseout="this.style.background='#24292e'">
              Ver Repositorio Universal en GitHub
            </a>
          </div>
