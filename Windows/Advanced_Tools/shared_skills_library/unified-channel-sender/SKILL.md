...
En Discord utiliza un Webhook configurado, y en Web envía los mensajes mediante HTTP POST al puerto local 7860. No contiene claves ni tokens harcodeados, leyendo todo directamente de `C:\Program Files\Chask_Swarn\Configuration\channels_config.json`.
