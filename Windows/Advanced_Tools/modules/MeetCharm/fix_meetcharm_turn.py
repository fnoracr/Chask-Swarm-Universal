...
docker_appjs = run(ssh,
    "find /var/lib/docker/overlay2/4850b44ae0c15c728f11c411ae574dc0a410a6ccacc8ee1d3a00d7253b901397/merged/opt/Meet[Nombre_IA]/static/ -name 'app.js' | head -1 | xargs cat 2>/dev/null | grep -i 'iceServer\\|TURN\\|STUN\\|config =' | head -5",
    wait=5)
...
if has_local_turn:
    ...
    run(ssh, 
        "cp /root/proyecto_norameet/frontend/app.js /var/lib/docker/overlay2/4850b44ae0c15c728f11c411ae574dc0a410a6ccacc8ee1d3a00d7253b901397/merged/opt/Meet[Nombre_IA]/static/app.js",
        wait=5)
    run(ssh,
        "cp /root/proyecto_norameet/frontend/app.js /var/lib/docker/overlay2/4850b44ae0c15c728f11c411ae574dc0a410a6ccacc8ee1d3a00d7253b901397/diff/opt/Meet[Nombre_IA]/static/app.js",
        wait=5)
...
# ─── 5. Forzar reload del container Meet[Nombre_IA] (sin downtime) ──────
print("\n=== [5/5] Reiniciando container Meet[Nombre_IA] para que sirva el nuevo app.js ===")
# Primero verificar que el contenedor esta en /opt/Meet[Nombre_IA]/static
container_static = run(ssh,
    "docker exec Meet[Nombre_IA]-api ls /opt/Meet[Nombre_IA]/static 2>/dev/null | grep app.js || echo 'static no montado como volumen'",
    wait=5)
...
if 'app.js' not in container_static:
    run(ssh,
        "docker cp /root/proyecto_norameet/frontend/app.js Meet[Nombre_IA]-api:/opt/Meet[Nombre_IA]/static/app.js 2>/dev/null || echo 'cp via docker fallido'",
        wait=8)
...
# Verificar final
final_check = run(ssh,
    "docker exec Meet[Nombre_IA]-api cat /opt/Meet[Nombre_IA]/static/app.js 2>/dev/null | grep 'turn:31' | head -2",
    wait=5)
