...
copy /Y "C:\Program Files\Chask_Swarm\Chask_Backups\pre_change\backup_20260516_185141\Prompt_Telegram_[Nombre_IA].md" "C:\Program Files\Chask_Swarm\Prompt_Telegram_[Nombre_IA].md" >nul
