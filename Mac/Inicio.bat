...
:: Asi, cerrar Charm NO mata los daemons.
:: ================================================================
...
:: ================================================================
:: [3/4] Abrir IDE de Charm DESPUES de los daemons
:: ================================================================
echo [3/4] Levantando Interfaz Neuronal (IDE Charm)...
...
echo [OK] Puedes cerrar Charm sin matar el enjambre.
echo ===================================================
echo.
