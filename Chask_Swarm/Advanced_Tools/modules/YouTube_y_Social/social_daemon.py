...
sys.path.append(r"C:\Program Files\Chask_Swarm\Automatizaciones")
...
def post_blog(title: str, content_html: str) -> str:
    ...
    try:
        blog_path = r"C:\Program Files\Chask_Swarm\Charm\blog.html"
...
TOOLS_SCHEMA = [
    ...
    },
    {
        ...
        "function": {
            "name": "post_blog",
            "description": "Publica un artículo en el Blog oficial (Charm_Blog.php) y lo sube al servidor.",
            "parameters": {
                "type": "object",
                "properties": {
...
def run_community_manager():
    ...
    img_dir = r"C:\Users\fnora\Desktop\Nora Datos\Imagenes_Social"
    ...
    system_prompt = (
        ...
        "REGLAS:\n"
        "1. Debes publicar PRIMERO en el Blog oficial usando la herramienta post_blog. Esto te dará la URL base: https://www.chask.fun/charm/Charm_Blog.php\n"
