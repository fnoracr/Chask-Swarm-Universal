...
def chask_swarm_architecture():
    ...
    groups = [
        ...
        {"id":"ide","label":"IDE Charm","color":"#10b981","x":1250,"y":50,"nodes":[
            {"id":"charm","label":"Charm IDE (Enjambre)","desc":"Interfaz principal donde Enjambre opera. Los daemons inyectan mensajes aquí via pyautogui+pyperclip (ctrl+v). Enjambre (Claude) responde desde aquí.","icon":"🖥️"},
            {"id":"inject","label":"inject_to_charm.py","desc":"Módulo de inyección universal. Busca la ventana de Charm, obtiene foco con truco Alt, pega con Ctrl+V. 3 reintentos con verificación de foco.","icon":"📌"},
        ]},
        ...
        {"id":"integrations","label":"Integraciones Externas","color":"#a855f7","x":850,"y":1500,"nodes":[
            ...
            {"id":"int_telegram","label":"Telegram","desc":"Bot Telegram integrado en unified_daemon (long polling). Envio via charm_telegram.py. Canal principal de comunicacion con Fernando.","icon":"✈️"},
