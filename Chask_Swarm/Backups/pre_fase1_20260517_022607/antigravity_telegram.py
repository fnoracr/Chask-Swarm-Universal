...
STATE_FILE = r"C:\Program Files\Chask_Swarm\Colas_Mensajes\telegram_state.txt"
MEDIA_DIR = r"C:\Program Files\Chask_Swarm\telegram_media"

# Setup ffmpeg for pydub
ffmpeg_path = r"C:\Program Files\Chask_Swarm\Binarios\ffmpeg.exe"
...
def check_messages_non_blocking():
    ...
    pending_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), "Colas_Mensajes", "pending_messages.json")
    try:
