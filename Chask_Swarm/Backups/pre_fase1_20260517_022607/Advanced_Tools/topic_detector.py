...
TOPIC_STOPWORDS = {
    "qué", "cómo", "cuál", "cuándo", "dónde", "por", "para", "con",
    "que", "como", "cual", "cuando", "donde", "hacer", "es", "son",
    "está", "están", "tiene", "tienen", "puedo", "puede", "quiero",
    "necesito", "ayuda", "explicar", "explicame", "dime", "muéstrame",
    "funciona", "funcione", "problema", "error", "fallo", "issue",
    "what", "how", "when", "where", "which", "can", "could", "would",
    "should", "help", "please", "show", "tell", "explain", "use",
    "using", "used", "this", "that", "these", "those", "there", "here",
}
