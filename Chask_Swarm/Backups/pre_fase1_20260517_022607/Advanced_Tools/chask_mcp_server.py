...
AGENTS_CONFIG_PATH = os.path.join(CHASK_ROOT, "agents_config.json")
TELEGRAM_SCRIPT = os.path.join(CHASK_ROOT, "antigravity_telegram.py")
...
async def handle_call_tool(name: str, arguments: dict | None) -> list[types.TextContent]:
    ...
    # ── Web ──
        ...
        out = _run_script(
            os.path.join(TOOLS_DIR, "universal_scraper.py"),
